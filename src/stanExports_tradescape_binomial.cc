...
#include "stanExports_tradescape_binomial.h"

RCPP_MODULE(stan_fit4tradescape_binomial_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_tradescape_binomial")
